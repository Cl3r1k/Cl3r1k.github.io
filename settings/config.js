...
export const AOSConfig = {
  ...
  once: true, // Choose whether animation should fire once, or every time you scroll up/down to element
};

export const SEND_SUCCESS_DELAY = 3000;
export const LOADER_DELAY = 1500;
export const LOADING_DELAY = 500;
export const COUNTER_DELAY = 10;
export const TYPING_DELAY = 4000;
export const SCROLL_THROTTLE = 100;
export const SKILL_SCROLL_TRIGGER = 400;
export const COUNTER_SCROLL_TRIGGER = 500;
